...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/content/drive/MyDrive/data_surface_roughness/VOCdevkit/VOC2007/coco.json',
        img_prefix='/content/drive/MyDrive/data_surface_roughness/VOCdevkit/VOC2007/ImageSets/',
