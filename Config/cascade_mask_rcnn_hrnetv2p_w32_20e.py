...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file='/content/drive/MyDrive/data_drawing_test/VOCdevkit/VOC2007/coco.json',
        img_prefix='/content/drive/MyDrive/data_drawing_test/VOCdevkit/VOC2007/ImageSets/',
        pipeline=test_pipeline))
