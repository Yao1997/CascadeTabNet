...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/content/drive/MyDrive/data/VOCdevkit/VOC2007/coco.json',
        img_prefix='/content/drive/MyDrive/data/VOCdevkit/VOC2007/ImageSets/',
...
load_from = None
resume_from = '/content/drive/My Drive/Mmdetection/new_chunk_cascade_mask_rcnn_hrnetv2p_w32_20e/epoch_7.pth'
workflow = [('train', 1)]
